...
const originalRouter = configureRouter();

app.get("*", (req: express.Request, res: express.Response) => {
  if (!appConfig.ssr) {
    // some api calls (like exp, some other data)
    // initial state.
  ...
  const router = cloneRouter(originalRouter);
  router.start(req.url, (error, routeState) => {
    ...
    const languageHelper = new LanguageHelper("en-us");
